% Titulo
\newcommand\reporttitle{\fontsize{13pt}{10pt}\selectfont Criação de uma Empresa}

% Modulo
\newcommand\reportsubtitle{
5065 - Empresa - Estructura e Funções
}
...
\newcommand{\autores}{%
    \begin{tabular}{@{}l@{}}
        \textbf{Autores:} \\[0.3em]
        João Correia \\[0.2em]
        Lucas Silvestre \\[0.2em]
        Vladimiro Bonaparte \\[0.2em]
    \end{tabular}%
}
...
\rhead{\raisebox{0.05\height}{ \reporttitle, \reportsubtitle}}
