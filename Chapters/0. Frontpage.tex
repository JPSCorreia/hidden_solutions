...
\begin{tikzpicture}
\node[inner sep=0pt] (logo) at (0,0.62)
    {\includegraphics[scale=0.7]{Figures/0. General/atec_2.png}};
{\setstretch{1.75}
\node[text width = 0.38\textwidth, yshift = 0.32cm, right = 1.25cm of logo](title){\sffamily\huge\reporttitle};
}   
...
\draw[line width=1.75mm, color_scheme]($(logo.east)!0.5!(title.west)$) +(0,\subtitley - 0.64cm) -- +(0,\titley - 0.91cm);
\end{tikzpicture}
...
% logotipo
\makebox[0.89\textwidth][r]{\includegraphics[scale=1.70]{Figures/0. General/hidden_solutions.jpg}}
...
% Autores e formador
\begin{tikzpicture}
    \setstretch{1.2} \node[text width = 0.23\textwidth] (autores) at (-0.25cm,0) {\sffamily\large\autores};
